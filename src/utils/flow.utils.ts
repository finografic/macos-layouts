 ...
 *
 * ⚠️  DO NOT EDIT THIS FILE DIRECTLY IN ANY INDIVIDUAL REPO.
 *
 * This file is the canonical source, maintained at:
 *   __FINOGRAFIC_FLOWS_FACTOR_V3/flow.utils.ts
 *
 * It is copied identically into each repo's src/utils/flow.utils.ts.
 * To make changes: edit the canonical source, then copy to all three repos
 * (gli, genx, macos-layouts) and verify each builds before committing.
 *
